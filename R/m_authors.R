      ...
      susAuthor("Han Qiao", 
                ...
                susAuthorBio(
                  curbcut::cc_t("Han Qiao is a PhD student at the Faculty of Inf",
                                ...
                                "arch interests are around hum",
                                "an computer interaction, design and urban susta",
                                "inability data. Her current project explores th",
                                "e design and impacts of urban data exploration ",
                                "and visualization tools and how different ways ",
                                "of knowing could be incorporated and valued in ",
